...
def obter_todos_pedidos():
    ...
    while True:
        ...
        for pedido in pedidos:
            ...
            tracking_code = detalhes.get('tracking_code', 'N/A')  # Verifique se o campo está correto
            tracking_info = obter_codigo_rastreamento(tracking_code)  # Pega o rastreamento usando o código
            pedido['tracking_info'] = tracking_info  # Adiciona as informações de rastreamento ao pedido
